        ...
        <div class="container">
            <div class="row"> 
                    <div class="card table-responsive col-md-12">
                        <h3>Planilla de Caddies Pagados</h3>
                        <hr>
                        <form action="pagosPlanillas.php" method="POST">
                    ...
                    <table id="caddie" class="table table-responsive table-condensed table-bordered table-hover display responsive nowrap" id='torneo' style="font-size:80%;">    
                        ...
                        <tbody>
                            <?php
                             ...
                             $planillas=getUsuariosTorneosPlanilla($usuario_id,$torneo_id,0);
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <a href="#" class="btn btn-dark">PAGADO</a>
                                <?php       
                                    }
                                  ?>      
                                </td>
