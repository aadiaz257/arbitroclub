...
<header>
	...
	<section id="container">
            <div class="container">
                    <div class="row"> 
                        <center>
                            <font color="black" align="center"><h1>Registrar Torneos</h1></font><hr>
                                <form action="accionestorneos.php" method="POST" class="col-md-12">
                                    ...
                                    <center><input type="submit" value="Registrar Torneo"class="btn btn-success btn-lg"></center>
                                </form>
                                <br>
                        </center>
                            ...
                            <table class=" table table-striped table-hover table align-middle" id="caddie">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <a href="accionestorneos.php?id=<?= $row['id'] ?>&accion=delete_torneo" class="btn btn-danger btn-sm">Eliminar</a>                                            
                                    	</th>                                        
                                    </tr>
