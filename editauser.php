...
<header>
	...
	<section id="container">            
            <div class="container">
                    <div class="row"> 
                        <center>
                            <font color="black" align="center"><h1>Editar Caddie:  <?php echo $nombre; ?></h1></font><hr> 
                            ...
                            <table class=" table table-striped table-hover table align-middle" id="caddie">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th><?= $row['nombre']?></th>
                                        <th><?= $row['apellido']?></th>    
                                        <th><a href="editauser.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Editar</a>
                                        <!--<a href="acciones.php?id=<?= $row['id'] ?>&accion=delete_usuario" class="btn btn-danger">Eliminar</a>
                                        -->    
                                        </th>                                        
                                    </tr>
